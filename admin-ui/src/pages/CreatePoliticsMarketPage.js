...
import { ArrowLeft, Calendar, Clock, User, Save, Send, AlertCircle, Vote } from 'lucide-react';
...
const CreatePoliticsMarketPage = () => {
  ...
  const handleSubmit = async (autoPublish = false) => {
    ...
    try {
      ...
      console.log('🗳️ Submit - MarketData:', marketData);
      ...
      <FormContainer>
        <MainForm>
          ...
          <Input
            ...
            placeholder="例如：2024年美国总统选举谁将获胜？"
          />
        ...
        <Sidebar>
          <PreviewCard>
            ...
            <PreviewHeader>
              <PreviewBadge>🗳️ 政治事件</PreviewBadge>
            </PreviewHeader>
...
export default CreatePoliticsMarketPage;