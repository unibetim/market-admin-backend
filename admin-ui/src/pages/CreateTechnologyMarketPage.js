...
import { ArrowLeft, Calendar, Clock, User, Save, Send, AlertCircle, Cpu } from 'lucide-react';
...
const CreateTechnologyMarketPage = () => {
      ...
      <FormContainer>
        <MainForm>
          ...
          <Input
            ...
            placeholder="例如：苹果公司会在2024年9月发布iPhone 16吗？"
          />
        ...
        <Sidebar>
          <PreviewCard>
            ...
            <PreviewHeader>
              <PreviewBadge>🔬 科技发展</PreviewBadge>
            </PreviewHeader>
...
export default CreateTechnologyMarketPage;