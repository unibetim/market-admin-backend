...
import { ArrowLeft, Calendar, Clock, User, Save, Send, AlertCircle, Plus } from 'lucide-react';
      ...
      <FormContainer>
        <MainForm>
          ...
          <Input
            ...
            placeholder="例如：2024年夏季奥运会中国代表团金牌数是否会超过40枚？"
          />
        ...
        <Sidebar>
          <PreviewCard>
            ...
            <PreviewHeader>
              <PreviewBadge>📋 其他事件</PreviewBadge>
            </PreviewHeader>
...
export default CreateOtherMarketPage;